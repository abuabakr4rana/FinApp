        ...
        public void Execute(SortedList<string, object> srt, StoredProcedures spname)
        {
            switch (spname)
            {
                ...
                case StoredProcedures.FinYear:
                    ...
                    break;
                case StoredProcedures.Customers:
                    SaveUpdateDelete(srt, "SP_fin_Customers");
                    break;
                case StoredProcedures.Product_Vendors:
                    SaveUpdateDelete(srt, "SP_fin_Vendors");
                    break;
                case StoredProcedures.Taxes:
                    SaveUpdateDelete(srt, "SP_fin_Taxes");
                    break;
                    //ExecuteNow
            }
        }
        ...
        public DataTable SelectExecute(StoredProcedures e, SortedList<string, object> srt)
        {
            ...
            switch (e)
            {
                ...
                case StoredProcedures.EntityTypes:
                    ...
                    break;
                case StoredProcedures.Customers:
                    dt = SelectValue("SP_fin_Customers", srt);
                    break;
                case StoredProcedures.Product_Vendors:
                    dt = SelectValue("SP_fin_Vendors", srt);
                    break;
                case StoredProcedures.Taxes:
                    dt = SelectValue("SP_fin_Taxes", srt);
                    break;
                    //SelectDataTable
            }
            return dt;
        ...
        public IDataReader SelectIDR(StoredProcedures e, SortedList<string, object> srt)
        {
            ...
            switch (e)
            {
                ...
                case StoredProcedures.FinYear:
                    ...
                    break;
                case StoredProcedures.Customers:
                    idr = SelectReader("SP_fin_Customers", srt);
                    break;
                case StoredProcedures.Product_Vendors:
                    idr = SelectReader("SP_fin_Vendors", srt);
                    break;
                case StoredProcedures.Taxes:
                    idr = SelectReader("SP_fin_Taxes", srt);
                    break;
                    //SelectIDR
            }
            return idr;
