<%@ Page Title="" Language="C#" MasterPageFile="~/FinApp/App.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="FinPro.FinApp.Default" %>
            ...
            <div id="example" class="k-content">
                ...
                <script>
                    function createChart() {
                        $("#chart").kendoChart({
                            title: {
                                text: "Monthly Account Activity Trend"
                            },
                            legend: {
                                position: "bottom"
                            },
                            ...
                            categoryAxis: {
                                categories: [<%= Get_LineChart_XAxisTitles() %>],
                                majorGridLines: {
                                    visible: false
                                }
                            },
