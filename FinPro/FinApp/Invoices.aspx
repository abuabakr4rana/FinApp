<%@ Page Title="" Language="C#" MasterPageFile="~/FinApp/App.Master" AutoEventWireup="true" CodeBehind="Invoices.aspx.cs" Inherits="FinPro.FinApp.Invoices" %>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box blue">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <asp:HyperLink ID="hplNewVouchar" runat="server" CssClass="btn btn-default btn-sm" NavigateUrl="~/FinApp/Invoice_New.aspx">
                                            ...
                                            <ItemTemplate>
                                                <tr class="grid_first_row">
                                                    <td>
                                                        ...
                                                        <asp:HyperLink ID="hplVouchar" runat="server" Text='<%# Eval("invUserGroupInvId").ToString() %>' NavigateUrl='<%# "~/FinApp/Invoice_Edit.aspx?id=" + Eval("invUid").ToString() %>'></asp:HyperLink>
                                                    </td>
                                                    <td>
                                                        <asp:Literal ID="ltrEntityTitle" runat="server" Text='<%# Eval("entityTitle").ToString() %>'></asp:Literal>
                                                    </td>
                                                    <td>
                                                        <asp:Literal ID="ltrDate" runat="server" Text='<%# Convert.ToDateTime(Eval("invDate")).ToString("MMM dd, yyyy") %>'></asp:Literal></td>
                                                    <td>
                                                        <asp:Literal ID="ltrDescription" runat="server" Text='<%# Eval("invItemDescription").ToString() %>'></asp:Literal>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <asp:Literal ID="ltrCreatedBy" runat="server" Text='<%# Eval("userFirstName").ToString() + " " + Eval("userLastName").ToString()  %>'></asp:Literal></td>
                                                    <td>
                                                        <asp:Label ID="lblStatus" runat="server" Text='<%# Eval("invStatusTitle") %>' CssClass='<%# "" %>'></asp:Label>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:ListView>
