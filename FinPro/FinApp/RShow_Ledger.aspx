<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RShow_Ledger.aspx.cs" Inherits="FinPro.FinApp.RShow_Ledger" %>
    ...
    <form id="frmReport" runat="server">
        <div>
            <telerik:ReportViewer ID="rvReport" runat="server" Height="800px" Width="100%">
                <typereportsource typename="rpLedger, FinPro, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null"></typereportsource>
